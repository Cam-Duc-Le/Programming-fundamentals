...
bool ChampionA::skill1(Champion& _champ){
	_champ.takePhysicalDamage(100 + (this->physicalDamage * 20) / 100);
}
bool ChampionA::skill2(Champion& _champ){
	_champ.takePhysicalDamage(20 + (this->physicalDamage * 80)/100 );
}
bool ChampionB::skill1(Champion& _champ){
	int z=30 + (this->abilityPower * 70) / 100;
	_champ.takeMagicDamage(z);
}
bool ChampionB::skill2(Champion& _champ){
	int z= 90 + (this->abilityPower * 30) / 100;
	_champ.takeMagicDamage(z);
}
